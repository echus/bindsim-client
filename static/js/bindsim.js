...
bindsim.sim_uv_1to1= {
    ...
    init: function() {
        console.log("bindsim.sim_uv_1to1.init called");

        // Initialise internal jQuery globals
        bindsim.sim_uv_1to1.i.$form = $(bindsim.sim_uv_1to1.i.form);

        // Show only selected simulator's form
        bindsim.i.$forms.hide();
        bindsim.sim_uv_1to1.i.$form.show();

        // Init new plot, remove old (if it exists)
        if (typeof bindsim.chart != 'undefined') {
            bindsim.chart.destroy();
        }
        bindsim.chart = bindsim.sim_uv_1to1.plot_setup();

        // Bind/rebind click on plot button to 1:1 plot function
        bindsim.i.$button.unbind("click");
        bindsim.i.$button.on("click", bindsim.sim_uv_1to1.plot);
    ...
    plot: function() {
        ...
        // Top-level function, do everything!
        console.log("bindsim.sim_uv_1to1.plot called");

        // Parse form into request json for bindsim api
        request = bindsim.params_to_json(bindsim.sim_uv_1to1.i.$form, bindsim.parse_fail);
        console.log("Parsed request json:");
        console.log(request);

        // Call bindsim with parsed request
        var endpoint = bindsim.i.endpoint+bindsim.sim_uv_1to1.i.endpoint;
        bindsim.bindsim_call(request, 
                             endpoint,
                             bindsim.sim_uv_1to1.plot_update, 
                             bindsim.backend_fail);
    ...
    plot_update: function(points, request) {
         ...
         * @param {array} points.mf_hg - As above
         */
        console.log("bindsim.sim_uv_1to1.plot_update called");
        console.log("plot_update: Received returned points");
        console.log(points);
        ...
        // Plot new data
        bindsim.chart.get("series-molefrac-h")
            .setData(points[bindsim.sim_uv_1to1.i.json_mf_h], false);
        bindsim.chart.get("series-molefrac-hg")
            .setData(points[bindsim.sim_uv_1to1.i.json_mf_hg], false);
        bindsim.chart.get("series-isotherm")
            .setData(points[bindsim.sim_uv_1to1.i.json_dd], false);
        bindsim.chart.redraw();
    },
    ...
    plot_setup: function() {
        ...
        var series = [{
            ...
            type: "area",
            yAxis: bindsim.i.axis_molefrac,
            color: bindsim.sim_uv_1to1.i.color_mf_h,
            marker: {enabled: false}
            }, {
            id: "series-molefrac-hg",
            name: "HG molefraction",
            type: "area",
            yAxis: bindsim.i.axis_molefrac,
            color: bindsim.sim_uv_1to1.i.color_mf_hg,
            marker: {enabled: false}
            }, {
            id: "series-isotherm",
            name: "Isotherm",
...
bindsim.sim_uv_1to2 = {
    ...
    init: function() {
        console.log("bindsim.sim_uv_1to2.init called");

        // Initialise internal jQuery globals
        bindsim.sim_uv_1to2.i.$form = $(bindsim.sim_uv_1to2.i.form);

        // Show only selected simulator's form
        bindsim.i.$forms.hide();
        bindsim.sim_uv_1to2.i.$form.show();

        // Init new plot, remove old (if it exists)
        if (typeof bindsim.chart != 'undefined') {
            bindsim.chart.destroy();
        }
        bindsim.chart = bindsim.sim_uv_1to2.plot_setup();

        // Bind/rebind click on plot button to 1:1 plot function
        bindsim.i.$button.unbind("click");
        bindsim.i.$button.on("click", bindsim.sim_uv_1to2.plot);
    ...
    plot: function() {
        ...
        // Top-level function, do everything!
        console.log("bindsim.sim_uv_1to2.plot called");

        // Parse form into request json for bindsim api
        request = bindsim.params_to_json(bindsim.sim_uv_1to2.i.$form, bindsim.parse_fail);
        console.log("Parsed request json:");
        console.log(request);

        // Call bindsim with parsed request
        var endpoint = bindsim.i.endpoint+bindsim.sim_uv_1to2.i.endpoint;
        bindsim.bindsim_call(request, 
                             endpoint,
                             bindsim.sim_uv_1to2.plot_update, 
                             bindsim.backend_fail);
    ...
    plot_update: function(points, request) {
        ...
        bindsim.chart.get("series-molefrac-hg")
            .setData(points[bindsim.sim_uv_1to2.i.json_mf_hg], false);
        bindsim.chart.get("series-molefrac-hg2")
            .setData(points[bindsim.sim_uv_1to2.i.json_mf_hg2], false);
        bindsim.chart.get("series-isotherm")
            .setData(points[bindsim.sim_uv_1to2.i.json_dd], false);
        bindsim.chart.redraw();
    },
    ...
    plot_setup: function() {
        ...
        var series = [{
            ...
            type: "area",
            yAxis: bindsim.i.axis_molefrac,
            color: bindsim.sim_uv_1to2.i.color_mf_h,
            marker: {enabled: false}
            }, {
            id: "series-molefrac-hg",
            name: "HG molefraction",
            type: "area",
            yAxis: bindsim.i.axis_molefrac,
            color: bindsim.sim_uv_1to2.i.color_mf_hg,
            marker: {enabled: false}
            }, {
            id: "series-molefrac-hg2",
            name: "HG2 molefraction",
            type: "area",
            yAxis: bindsim.i.axis_molefrac,
            color: bindsim.sim_uv_1to2.i.color_mf_hg2,
            marker: {enabled: false}
            }, {
            id: "series-isotherm",
            name: "Isotherm",
